...
'chat.status.approvalNever': 'Never ask',
...
'chat.status.approvalCustom': 'Custom',
'chat.approvalMode.title': 'Approval mode',
'chat.approvalMode.open': 'Set approval mode, currently {value}',
'chat.approvalMode.untrustedHint': 'Only trusted actions run directly; Codex asks before anything else.',
'chat.approvalMode.onRequestHint': 'Codex asks when it needs additional permissions.',
'chat.approvalMode.neverHint': 'Never asks; actions outside the current access level fail immediately.',
'chat.approvalMode.nextTurn': 'Changes apply to your next message',
'chat.approvalMode.saved': 'Approval mode updated for your next message',
'chat.approvalMode.saveFailed': 'The approval mode could not be saved',
