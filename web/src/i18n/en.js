...
'chat.managedGuide.confirmHint': 'The current Codex process will end, including any task in progress. Handmux only resumes the confirmed original session and never accepts trust prompts for you.',
...
'chat.managedGuide.manualHint': 'The original session could not be identified safely, so the current process was left untouched. Exit it in the terminal, then run handmux codex resume.',
