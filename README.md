...
- **Chat view** — read and drive Codex CLI through App Server with Markdown bubbles, tool cards and live session status; Claude Code chat is an independently enabled experimental option.
