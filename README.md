...
- **Chat view (experimental)** — read and drive Claude Code / Codex with Markdown bubbles and tool cards; take over a plain Codex pane in one tap, then keep chat, approvals, stopping, model and reasoning controls synchronized through App Server.
