...
- **Chat view (experimental)** — read and drive Claude Code / Codex with Markdown bubbles and tool cards; take over a plain Codex pane in one tap, then keep messages, questions, approvals, stopping and conversation controls synchronized through App Server.
