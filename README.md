...
- **Chat view (experimental)** — read and drive Claude Code / Codex as a mobile conversation with Markdown bubbles and tool cards; enable it in Settings and switch back to the terminal at any time.
