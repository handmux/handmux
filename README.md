...
- **Chat view (experimental)** — read and drive Claude Code / Codex with Markdown bubbles and tool cards; start Codex with `handmux codex` to keep messages, questions, approvals, stopping and conversation controls synchronized through App Server.
