...
- **Ideas — catch every one** — a thought the moment it strikes: a per-window idea/to-do list, jot one with live streaming dictation (selectable Tencent Cloud or iFlytek) and drop it straight into the prompt.
