...
- **Chat view** — drive Codex CLI through App Server with Markdown bubbles, tool cards, persistent task goals and live status; existing panes can switch in place, and messages sent during a turn form an editable server queue. Claude Code chat is an independently enabled experimental option.
