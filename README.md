...
- **Chat view** — read and drive Codex CLI through App Server with Markdown bubbles, tool cards, persistent task goals and live session status; an existing Codex pane can switch to managed chat in place. Claude Code chat is an independently enabled experimental option.
