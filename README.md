...
- **Chat view (experimental)** — read and drive Claude Code / Codex with Markdown bubbles and tool cards; managed Codex synchronizes chat, approvals and stopping through App Server, without Codex hooks.
