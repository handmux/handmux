...
- **Chat view (experimental)** — read and drive Claude Code / Codex with Markdown bubbles and tool cards; managed Codex keeps chat, approvals and stopping synchronized with the terminal.
