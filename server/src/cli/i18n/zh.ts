...
export default {
  ...
  'auth.warning': '⚠ 设备保护未开启，当前只需 Token 即可访问。运行 handmux auth device on 可开启设备保护。',
  'auth.deviceDisableConfirm': '关闭后只凭 Token 就能访问，设备限制将失效。确定关闭设备保护吗？',
  'auth.addressDisableConfirm': '关闭后不再限制访问地址，任何地址都可以尝试连接。确定关闭地址限制吗？',
  ...
  'setup.voiceSetup': '开启语音输入吗?(支持实时听写或整句识别)',
  'setup.voiceProvider': '语音服务',
  'setup.voiceTencent': '腾讯云实时语音识别',
  'setup.voiceTencentHint': 'WebSocket 2.0 · 实时返回',
  'setup.voiceTencentSentence': '腾讯云一句话识别',
  'setup.voiceTencentSentenceHint': '点击录音 · 停止后整句返回',
  'setup.voiceXfyun': '讯飞语音听写',
  'setup.voiceXfyunHint': '实时返回',
  ...
  'setup.voiceTencentEngine': 'engineModelType（16k PCM，默认 16k_zh）',
  'setup.voiceSkipped': '  (已跳过 —— 字段缺失)',
  'setup.voiceVerifying': '→ 正在向服务商验证 {profile}…',
  'setup.voiceVerified': '✓ 语音配置验证通过',
  'setup.voiceVerifyFailed': '✗ 语音配置验证失败：{msg}。请检查填写内容或网络，修改任一字段后会重新验证。',
  'setup.voiceVerifyUnavailable': '⚠ 当前语音服务商暂不支持自动验证。',
