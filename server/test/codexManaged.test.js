...
import { codexAppSocketPath, runManagedCodex } from '../src/cli/codexManaged.js';

function child({ exits = false } = {}) {
  const process = new EventEmitter();
  process.exitCode = null;
  process.signalCode = null;
  process.kill = () => { process.exitCode = 0; process.emit('exit', 0, null); };
